...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionexport_landmark_to_TextGrid = QAction(MainWindow)
        self.actionexport_landmark_to_TextGrid.setObjectName(u"actionexport_landmark_to_TextGrid")
        self.actionexport_landmark_to_csv = QAction(MainWindow)
        self.actionexport_landmark_to_csv.setObjectName(u"actionexport_landmark_to_csv")
        self.actionexport_landmark_to_JSON = QAction(MainWindow)
        self.actionexport_landmark_to_JSON.setObjectName(u"actionexport_landmark_to_JSON")
        ...
        self.menuexport.addAction(self.actionexport_landmark_to_JSON)
        self.menuexport.addAction(self.actionexport_landmark_to_TextGrid)
        self.menuexport.addAction(self.actionexport_landmark_to_csv)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionexport_landmark_to_TextGrid.setText(QCoreApplication.translate("MainWindow", u"export landmark to TextGrid", None))
        self.actionexport_landmark_to_csv.setText(QCoreApplication.translate("MainWindow", u"export landmark to csv", None))
        self.actionexport_landmark_to_JSON.setText(QCoreApplication.translate("MainWindow", u"export landmark to JSON", None))
